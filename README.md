...
- **Server Port**: Set the port number (default: `8080`).
- **API Key**: Optional authentication key.
- **Enable Logging**: Toggle verbose logging.
- **Max Tokens**: Set the maximum number of tokens per response.
...
- Access the API at `http://localhost:8080/v1/chat/completions` (or your configured URL/port).
